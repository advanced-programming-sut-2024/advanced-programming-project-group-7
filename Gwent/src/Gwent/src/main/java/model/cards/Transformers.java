...
public class Transformers extends Card {

    public Transformers(String cardName, int countOfCard, boolean isSpecial, int power, String factionName, int rows, boolean isHero) {

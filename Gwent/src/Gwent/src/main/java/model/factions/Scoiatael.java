...
//    private final static HashMap<Card,Integer> scoiataelDefaultDeck=new HashMap<>();
//    static {
//        scoiataelDefaultDeck.put(new Decoy("horn", 3, true, 0, "special"),1);
//        scoiataelDefaultDeck.put(new Horn("decoy", 3, true, 0, "special"),3);
//        scoiataelDefaultDeck.put(new Scorch("scorch", 3, true, 0, "special"),1);
//        scoiataelDefaultDeck.put(new Card("frost", 3, true, 0, "weather"),1);
//        scoiataelDefaultDeck.put(new Card("ciri", 1, false, 15, "neutral"),1);
//        scoiataelDefaultDeck.put(new Card("geralt", 1, false, 15, "neutral"),1);
//        scoiataelDefaultDeck.put(new Card("iorveth", 1, false, 10, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new MoralBoost("isengrim", 1, false, 10, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Card("triss", 1, false, 7, "neutral"),1);
//        scoiataelDefaultDeck.put(new Scorch("villen", 1, false, 7, "neutral"),1);
//        scoiataelDefaultDeck.put(new Medic("yennefer", 1, false, 7, "neutral"),1);
//        scoiataelDefaultDeck.put(new MoralBoost("olgierd", 1, false, 6, "neutral"),1);
//        scoiataelDefaultDeck.put(new Card("vesemir", 1, false, 6, "neutral"),1);
//        scoiataelDefaultDeck.put(new Agile("yaevinn", 1, false, 6, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Card("emiel", 1, false, 5, "neutral"),1);
//        scoiataelDefaultDeck.put(new Card("mahakam", 1, false, 5, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Card("mahakam 1", 1, false, 5, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Muster("gaunter odimm darkness", 3, false, 4, "neutral"),3);
//        scoiataelDefaultDeck.put(new Muster("dwarf", 1, false, 3, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Muster("dwarf 1", 1, false, 3, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Horn("dandelion", 1, false, 2, "neutral"),1);
//        scoiataelDefaultDeck.put(new Muster("gaunter odimm", 1, false, 2, "neutral"),1);
//        scoiataelDefaultDeck.put(new Medic("havekar nurse", 1, false, 0, "scoiatael"),1);
//        scoiataelDefaultDeck.put(new Spy("mysterious elf", 1, false, 0, "neutral"),1);
//    }
...
//    public static HashMap<Card,Integer> getScoiataelDefaultDeck(){
